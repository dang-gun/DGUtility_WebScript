import DG_jsFileSelector2 from "./DG_jsFileSelector2";

export default class StartUp
{
    private DG_jsFileSelector2: DG_jsFileSelector2;
    ...
    public Test_GetItemList(): void
    {
        console.log(this.DG_jsFileSelector2.GetItemList());
    }

    public FS_LoadComplete(): void
    {
        console.log('로드 완료');
    }
}