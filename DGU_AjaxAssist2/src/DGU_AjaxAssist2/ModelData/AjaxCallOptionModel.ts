...
import { AjaxCallFetchOptionInterface } from "./AjaxCallFetchOptionInterface";
export * from "./AjaxCallFetchOptionInterface";

import { AjaxCallMethodType } from "./AjaxCallMethodType";
export * from "./AjaxCallMethodType";

import { AjaxCallOptionCheckCompleteDataModel } from "./AjaxCallOptionCheckCompleteDataModel";
...
export class AjaxCallOptionModel
{
	 ...
	 */
	success?: ((data: null | Response | ArrayBuffer | string | any, response: Response) => void) | null = null;
	/**
	 ...
	 * @param response 요청이 전달한 리스폰스
	 */
	error?: ((response: Response) => void) | null = null;
}