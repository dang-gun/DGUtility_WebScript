declare class DG_Popup2
{
    private ShowDefaultOption;
    private ZIndex: number;
    private ZIndexAdd: number;
    private PopupIndex: number;
    private CurrentSelectIndex: number;
    private CurrentSelectDiv: HTMLDivElement | null;
    private MouseState: number;
    private MouseDownX: number;
    private MouseDownY: number;
    private List: HTMLDivElement[];
    public Show: (Option: PopupJsonShowDefaultOption | MessageBoxShowDefaultOption) => HTMLDivElement;
    private CutBack: (sData: string) => number;
    public Close: () => void;
    private CloseIndex: (nIndex: number) => void;
    public CloseAll: () => void;
    public CloseTarget: (objTarget: HTMLDivElement) => void;
    private CreatePopupParent: (
        Option: PopupJsonShowDefaultOption,
        nPopupIndex: number
    ) => HTMLDivElement;
    private CreatePopupOverlay: (
        Option: PopupJsonShowDefaultOption,
        nPopupIndex: number,
        nZIndex: number
    ) => HTMLDivElement;
    ...
    private TitleMouseDownEvent: (e: MouseEvent) => void;
    private TitleMouseMoveEvent: (e: MouseEvent) => void;
    private TitleMouseUpEvent: (e: MouseEvent) => void;
}

declare interface PopupJsonShowDefaultOption
{
    /**
     * 인덱스 지정
